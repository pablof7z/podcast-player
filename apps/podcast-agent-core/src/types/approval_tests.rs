//! Tests for [`super::approval`] — PendingApproval and ApprovalDecision serde coverage.
//!
//! Extracted from `approval.rs` to keep that file under the 500-line hard limit.
