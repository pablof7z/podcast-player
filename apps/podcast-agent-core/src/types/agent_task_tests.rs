//! Tests for [`super::agent_task`] — TaskKind, TaskStatus, and AgentTask serde coverage.
//!
//! Extracted from `agent_task.rs` to keep that file under the 500-line hard limit.
