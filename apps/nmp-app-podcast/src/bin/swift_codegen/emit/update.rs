...
pub(super) fn emit_podcast_update() -> String {
...
struct PodcastUpdate {
    ...
    @DefaultEmptyArray var friends: [FriendSummary] = []
...
/// Mirrors the kernel's feedback-thread projection DTO (snake_case fields
...
/// Mirrors the kernel's feedback-reply projection DTO.
...
extension PodcastUpdate: Codable {
    init(from decoder: Decoder) throws {
        ...
        friends = try c.decodeIfPresent([FriendSummary].self, forKey: .friends) ?? []
