//! `nmp_app_podcast_elevenlabs_tts_synthesize` — shared ElevenLabs TTS.
...
pub extern "C" fn nmp_app_podcast_elevenlabs_tts_synthesize(
...
fn tts_error_envelope(error: &ElevenLabsTtsError) -> CString {
