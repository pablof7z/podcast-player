use crate::agent_note_handler::{
    build_agent_note_tags, handle_fetch_agent_notes, handle_publish_agent_note,
};
...
const PEER_PUBKEY_HEX: &str = "3bf0c63fcb93463407af97a5e5ee64fa883d107ef9e558472c4eb9aaaefa459d";
