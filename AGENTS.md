...
- NMP migration doctrine applies when work is explicitly part of the NMP migration. For current Swift app work, preserve existing app architecture unless the active plan says to move a behavior into the NMP/Rust substrate.
