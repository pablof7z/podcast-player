...
- `docs/plan/ci-runner-decision.md` - decision and migration plan for moving the per-PR `Build and Test` gate from the self-hosted runner to GitHub-hosted `macos-26` (issue #752).
