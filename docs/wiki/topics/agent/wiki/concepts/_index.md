# Agent Concepts Index

> Focused concepts for the Podcastr embedded agent.
...
- **tools**: tool-surface.md, lifetime-tool-catalog.md, tenex-delegate-tool.md, tool-execution-infrastructure.md
