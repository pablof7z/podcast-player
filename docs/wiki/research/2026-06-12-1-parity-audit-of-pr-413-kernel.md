...
characterization: "Parity audit of PR #413 (kernel AI chapters+ads port from Swift to Rust): systematic comparison across mode selection, ad-validation rules, prompts, LLM invocation, call sites, persistence, and golden files; verdict REQUEST-CHANGES due to orphaned overlapsAd Swift compile break"
captured_at: 2026-06-12T21:53:11Z
---

Parity audit of PR #413 (kernel AI chapters+ads port from Swift to Rust): systematic comparison across mode selection, ad-validation rules, prompts, LLM invocation, call sites, persistence, and golden files; verdict REQUEST-CHANGES due to orphaned overlapsAd Swift compile break
