...
// authorization event THROUGH THE KERNEL (D13 — no signing in Swift), PUTs
// `/upload`, and returns the descriptor URL the server hands back. One Blossom
// host — no abstraction layer, no fallback list. If the default goes down, swap
