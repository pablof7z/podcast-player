...
final class UserIdentityStore {
    ...
    private static let userKeyService = "\(Bundle.main.bundleIdentifier ?? "Pod0").user-identity"
    ...
    private static let nip46SessionService = "\(Bundle.main.bundleIdentifier ?? "Pod0").nip46-session"
    private static let nip46SessionAccount = "session-private-key-hex"
    private static let nip46MetaService = "\(Bundle.main.bundleIdentifier ?? "Pod0").nip46-meta"
