    ...
    private static var generateTTSEpisodeSchema: [String: Any] {
        functionTool(
            ...
            properties: [
                ...
                "podcast_id": ["type": "string", "description": "UUID of an agent-owned podcast to publish the episode to (from create_podcast or list_my_podcasts). Omit to publish to the default 'Agent Generated' show. When the target podcast is public and Nostr is enabled, the episode is automatically published as a NIP-F4 kind:54 event."],
            ],
