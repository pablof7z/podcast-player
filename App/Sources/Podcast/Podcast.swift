...
struct Podcast: Codable, Sendable, Identifiable, Hashable {
    ...
    enum NostrVisibility: String, Codable, Sendable, Hashable {
        ...
        case `private`
        /// Published as NIP-F4 events signed by the podcast's key.
        case `public`
    }
    ...
    /// Hex public key of the podcast identity. Non-nil only for
    ...
    /// (i.e. shows published by others). Format: `"10154:<podcast-pubkey-hex>"`.
