...
struct AgentPodcastsView: View {
    ...
    private var podcastsSection: some View {
        Section {
            ...
            Text("Public shows are published as NIP-F4 Nostr events (kind:10154) signed by each podcast's own key. Episodes added to public shows are also published when Nostr is enabled.")
        }
    }
